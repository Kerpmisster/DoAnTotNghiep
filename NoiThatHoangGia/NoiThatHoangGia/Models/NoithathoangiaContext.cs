...
public partial class NoithathoangiaContext : DbContext
{
    public NoithathoangiaContext()
    {
    }

    public NoithathoangiaContext(DbContextOptions<NoithathoangiaContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Server=LAPTOP-SSHUBNQA\\SQLEXPRESS;Database=NOITHATHOANGIA;uid=sa;pwd=123456;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PARTNER__3214EC27FD99E182");
