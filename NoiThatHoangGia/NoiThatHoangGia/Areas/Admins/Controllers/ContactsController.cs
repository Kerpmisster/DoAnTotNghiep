...
namespace NoiThatHoangGia.Areas.Admins.Controllers
{
    ...
    public class ContactsController : Controller
    {
        ...
        public ContactsController(NoithathoangiaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Fullname,Phone,Content,CreatedDate,UpdatedDate,Status,Isdelete")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fullname,Phone,Content,CreatedDate,UpdatedDate,Status,Isdelete")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
